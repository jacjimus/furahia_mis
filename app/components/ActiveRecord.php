...
abstract class ActiveRecord extends CActiveRecord {
        ...
        public function loadMod($attr)
        {
                $model = $this->findByAttributes($attr);
                if ($model === null)
                        $model = new $this;
                return $model;
        }
         ...
         * @return type
         */
        public function getTotals($conditions = null, $params = array(),$group_by = null)
        {
                return $this->getScaler('count(*)', $conditions, $params , $group_by);
        }
