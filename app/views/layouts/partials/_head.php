<head>
        ...
        <script src="<?php echo $this->getPackageBaseUrl() . '/js/tabs/jquery.hashchange.min.js' ?>"></script>
        <script src="<?php echo $this->getPackageBaseUrl() . '/js/tabs/jquery.easytabs.js' ?>"></script>
        <script src="<?php echo $this->getPackageBaseUrl() . '/js/tabs/jquery.easytabs.min.js' ?>"></script>
        <script src="<?php echo $this->getPackageBaseUrl() . '/js/tabs.js' ?>"></script>
