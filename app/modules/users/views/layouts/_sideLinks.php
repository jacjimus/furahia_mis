<?php if ($this->showLink(UserResources::RES_USER_ADMIN)): ?>
        <li class="<?php echo $this->getModuleName() === 'users' ? 'active open' : '' ?>">
                <a href="<?php echo Yii::app()->createUrl('users/default/index') ?>" class="dropdown-toggle">
                        <i class="icon-lock"></i>
                        <span class="menu-text"> <?php echo Lang::t('Access Control Module') ?></span>
                ...
                <ul class="submenu">
                        ...
                        <?php if ($this->showLink(UserResources::RES_USER_LEVELS)): ?>
                                <li class="<?php echo $this->activeMenu === UsersModuleController::MENU_USER_LEVELS ? 'active' : '' ?>"><a href="<?php echo Yii::app()->createUrl('users/userLevels/index') ?>"><i class="icon-double-angle-right"></i><?php echo Lang::t('Manage User Levels') ?></a></li>
                                        <?php endif; ?>
                </ul>
        </li>
<?php endif; ?>
