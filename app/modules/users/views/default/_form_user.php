...
<?php if ($model->getIsNewRecord() || $can_update) : ?>
        ...
        <div class="form-group">
                <?php echo CHtml::activeLabelEx($model, 'client_id', array('class' => $label_class, 'label' => Lang::t('Client / Partner'))); ?>
                <div class="<?php echo $input_class ?>">
                        <?php echo CHtml::activeDropDownList($model, 'client_id', Clients::model()->getListData('id', 'client_name','','',array(),'client_name'), array('class' => 'form-control')); ?>
               </div>
        </div>
        <div class="form-group">
