...
<div class="row grid-view-header">
        <div class="col-sm-6">
                <div class="btn-group">
                        <?php if ($this->showLink($this->resource, Acl::ACTION_CREATE)): ?><a class="btn btn-sm" href="<?php echo $this->createUrl('create') ?>"><i class="icon-plus-sign"></i> <?php echo Lang::t('Add ' . $this->resourceBulkLabel) ?></a><?php endif; ?>
                </div>
        </div>
        <div class="col-sm-6">
...
$this->widget('application.components.widgets.GridView', array(
    ...
    'columns' => array(
        array(
         ...
         array(
            'name' => 'client',
            'visible' => empty(Yii::app()->user->client),
        ),
        array(
            'name' => 'description',
            'type' => 'raw',
