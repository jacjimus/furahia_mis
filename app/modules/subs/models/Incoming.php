...
class Incoming extends ActiveRecord {
      ...
      public function rules()
	{
		...
		return array(
			...
			array('productid, serviceid, servicelist, updatetype, updatetime, updatedesc, effectivetime, expirytime, extensioninfo, msisdn, userid_type, spid', 'length', 'max'=>300),
			array('fulldump', 'safe'),
